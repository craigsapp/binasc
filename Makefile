...
## Last Modified: Wed Jan 30 19:43:24 PST 2013
...
# uncomment out ARCH variables for 32-bit compiling on 64-bit computers
# (see the OS X and Linux variants below for ARCH).
ARCH = 
